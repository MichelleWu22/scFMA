...
{ 
  ...
  for (i in 1:qujian) {
    ...
    pio12.8c[which(pio1.8c==0)]<-rbeta(sum(pio1.8c==0),initialalfa8c, initialbeta8c)
    ...
    pio12.4c[which(pio1.4c==0)]<-rbeta(sum(pio1.4c==0),initialalfa4c, initialbeta4c)
...
save(res, file="simulation/nodifference.beta_est.Rdata")
